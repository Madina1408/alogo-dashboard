...
export function Card({id, image, number, performanceType, statistics, monthlyData}) {
  return (
    <div className="card group">
      ...
      <div key={id}>
        <div className="bg-skin-fill group-hover:bg-orange-300 card-image-div h-9 w-10 rounded-md p-2.5 text-white">{image}</div>
        <p className="group-hover:text-white card-number text-2xl text-skin-base font-bold">{number}</p>
