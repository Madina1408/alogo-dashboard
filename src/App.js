...
export function App() {
  ...
  return (
    <div className={theme=='yellow'? 'theme-yellow': theme == 'purple'? 'theme-purple': theme == 'dark-blue'? 'theme-dark-blue':''} >
        ...
        <div className="bg-palm bg-opacity-25 h-full bg-no-repeat bg-cover w-full md:w-10/12 ">
          ...
          <div className="w-full flex xl:flex-row sm:flex-col">
            ...
            <div className="xl:w-2/5 w-10/12 mx-auto borderBottom ">
              <BarChartContainer theme = {theme}  />
              <HorBarChartContainer theme = {theme}  />
              <CitiesCard />
            </div>
          </div>
        </div>
